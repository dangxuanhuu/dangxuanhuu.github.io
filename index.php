...
<!-- end slider -->
    <div class="container">
      ...
      <!-- end container -->
      <h2 style="color: chocolate;">Danh mục xe đạp</h2>
      <div class="content">
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <img src="img/22.webp" alt="" class="img-fluid">
                    <a href="">Xe đạp thể thao, đen </a>
                    <p>2.200.000</p>
                </div>
                <div class="col-md-3">
                    <img src="img/16.webp" alt="" class="img-fluid"><br>
                    <a href="">Xe đạp thể thao, xanh</a>
                    <p>1.800.000</p>
                </div>
                <div class="col-md-3">
                    <img src="img/19.png" alt="" class="img-fluid"><br>
                    <a href="">Xe đạp thể thao, đỏ</a>
                    <p>1.00.000</p>
                </div>
                <div class="col-md-3">
                    <img src="img/18.webp" alt="" class="img-fluid"><br>
                    <a href="">Xe đạp thể thao, đen</a>
                    <p>4.200.000</p>
                </div>
            </div>
