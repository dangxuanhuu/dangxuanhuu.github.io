...
<html lang="en">
  <head>
    <title>Xe Đạp giá thấp nhất</title>
...
<!-- end slider -->
    <div class="container">
     ...
     <h2 style="color: chocolate; text-align:center">LOẠI XE GIÁ THẤP NHẤT</h2>
    <div class="spthapnhat">  
        <?php
        $x = "SELECT * from giathapnhat ";
        $data = mysqli_query($ketnoi, $x);
        if (mysqli_num_rows($data) > 0) {

            while ($row = mysqli_fetch_assoc($data)) { ?>
                <div class="mz3" style="cursor: pointer; ">
                    <img style=" height: 250px;  width: 250px;" src="img_spthapnhat/<?php echo $row["hinhanh"]?>.jpg" alt="">
                    <h3><a onclick="window.location = './chitietxe.php?dongxe=<?php echo $row['dongxe']; ?>'" style="color:black;text-decoration: none;"><?php echo $row["tensp"]?></a></h3>
                    <p> Giá xe :<?php echo $row["gia"]?>.000</p>
                    <div class="btn btn-warning">
                        <a style="color:black;text-decoration: none;" onclick="window.location = './chitietxe.php?dongxe=<?php echo $row['dongxe']; ?>'">
                        XEM CHI TIẾT </a>
                    </div>
