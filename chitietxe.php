<?php 
  ...
  $idsp = $_GET['id_sp'];
$sql = "SELECT * FROM chitietxe WHERE id_sp = '$idsp'";
...
<!-- end slider -->
    <div class="container">
      ...
      <!-- end container -->
      <div> <H3 style="margin-right: 400px; height: 100px;width: 100%; text-align: center;">THÔNG TIN CHI TIẾT</H3></div>
        <div class="thongtinxe" style="display: flex;justify-content: space-around;margin-bottom: 40px;" >
        <?php while ($row = mysqli_fetch_array($query)) { 
            ?>
            <div><img src="img_chitietxe/<?php echo $row["hinhanh"]?>.jpg" alt="" style="height: auto; width: 400px;position: relative;left: 50%;transform: translateX(-50%);"></div>
            <div class="thongtin" style="position: relative;left: -250px;">
                <div  style="color: goldenrod; font-weight: bold;"> <h3 style="color: black;" >TÊN XE:&nbsp &nbsp<?php echo $row['tensp']; ?></h3></div>
            <div style="color: goldenrod; font-weight: bold;margin-top: 30px;"> <h3 style="color: black;">GIÁ XE:&nbsp &nbsp<?php echo $row['gia']; ?>.000</h3></div>
            <div> <h3 style="margin-top: 30px;">XUẤT XỨ:&nbsp &nbsp<?php echo $row['xuatxu']; ?></h3></div>
            <div> <h3 style="margin-top: 30px;">LOẠI XE:&nbsp &nbsp<?php echo $row['loaixe']; ?></h3></div>
            <div> <h3 style="margin-top: 30px;">MÀU XE:&nbsp &nbsp<?php echo $row['mau']; ?></h3></div>
            </div>
