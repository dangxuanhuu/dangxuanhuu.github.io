...
<!-- end slider -->
    <div class="container">
      ...
      <!-- end container -->
     <!-- bắt đầu code phần xe - sản phẩm -->
     <h2 style="color: chocolate;text-align:center">LOẠI XE ĐẠP DÀNH CHO NAM</h2>
    <div class="spnam">  
        <?php
        $x = "SELECT * from sanphamnam ";
        $data = mysqli_query($ketnoi, $x);
        if (mysqli_num_rows($data) > 0) {
            while ($row = mysqli_fetch_assoc($data)) { ?>
                <div class="mz3" style="cursor: pointer; ">
                    <img style=" height: 250px;  width: 250px;" src="img_spnam/<?php echo $row["hinhanh"]?>.jpg" alt="">
                    <h3><a onclick="window.location = './chitietxe.php?id_sp=<?php echo $row['id_sp']; ?>'" style="color:black;text-decoration: none;"><?php echo $row["tensp"]?></a></h3>
                    <p> Giá xe :<?php echo $row["gia"]?>.000</p>
                    <div class="btn btn-warning">
                        <a style="color:black;text-decoration: none;" onclick="window.location = './chitietxe.php?id_sp=<?php echo $row['id_sp']; ?>'">
                        XEM CHI TIẾT </a>
                    </div>
                </div>
        <?php }
            ...
            <div class="col-md-4">
                ...
                <div class="right">
                    <span>Địa chỉ: Số 62, Quốc Lộ 13 Cũ, Khu Phố 3, Phường Hiệp Bình Phước, Quận Thủ Đức<br>
                        ...
                        Email: <a href=""> pat@patcycle.com.vn</a></span>
                </div>
            </div>
            <div class="col-md-4">
                <div class="left">
