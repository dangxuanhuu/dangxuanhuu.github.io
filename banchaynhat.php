...
<html lang="en">
  <head>
    <title>Xe Đạp bán chạy nhất</title>
...
<!-- end slider -->
    <div class="container">
     ...
     <h2 style="color: chocolate;text-align: center;">LOẠI XE BÁN CHẠY NHẤT</h2>
    <div class="spbanchaynhat">  
        <?php
        $x = "SELECT * from banchaynhat ";
        $data = mysqli_query($ketnoi, $x);
        if (mysqli_num_rows($data) > 0) {

            while ($row = mysqli_fetch_assoc($data)) { ?>
                <div class="mz3" style="cursor: pointer; ">
                    <img style=" height: 250px;  width: 250px;" src="img_spbanchay/<?php echo $row["hinhanh"]?>.jpg" alt="">
