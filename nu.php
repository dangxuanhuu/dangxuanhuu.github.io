...
<!-- end slider -->
    <div class="container">
     ...
     <h2 style="color: chocolate;text-align:center">LOẠI XE ĐẠP DÀNH CHO NỮ</h2>
    <div class="spnu">
        <?php
        $x = "SELECT * from sanphamnu ";
        $data = mysqli_query($ketnoi, $x);
        if (mysqli_num_rows($data) > 0) {

            while ($row = mysqli_fetch_assoc($data)) { ?>
                <div class="mz3" style="cursor: pointer; ">
                    <img style=" height: 250px;  width: 250px;" src="img_spnu/<?php echo $row["hinhanh"]?>.jpg" alt="">
