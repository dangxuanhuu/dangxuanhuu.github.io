...
<!-- end slider -->
    <div class="container">
      ...
      <!-- end container -->
      <h3 style="color: chocolate;">Đăng Ký Thành Viên</h3>
      <div style="display:flex;justify-content: space-around;
  align-items: center; width:80%; height: 100%; margin-top: 30px" class="dangky">

 <form action="xldangki.php" method="POST">
   <table>
     <tr>
       <td>Tên Đăng Nhập</td>
     ...
     <td>
       ...
       <button type="reset" name="submit">Hủy</button>
     </td>
   </table>
 </form>
 </div>
